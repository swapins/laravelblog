...
<x-guest-layout>
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <div class="w-full bg-white shadow-md rounded my-6">
            <h1 class="text-2xl font-bold mb-4">My Blog Posts</h1>
            <table class="min-w-max w-full table-auto">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        <th class="py-3 px-6 text-left">Title</th>
                        <th class="py-3 px-6 text-left">Auther</th>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                ...
                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                <form id="deletePostForm_{{$post->id}}" action="/delPost/{{$post->id}}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <a href="#" onclick="submitForm('{{$post->id}}')">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
