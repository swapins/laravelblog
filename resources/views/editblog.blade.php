...
<x-guest-layout>
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        @endif
        <form method="POST" class="border w-full rounded-lg p-4" action="/editPost/{{$post->id}}">
            @csrf
            ...
            <div class="mb-4">
                ...
                value = "{{$post->title}}"
                name = "title" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                required>
            </div>

            <div class="mb-4">
                <label for="content" class="block text-gray-700 font-semibold mb-2">Content</label>
                <textarea id="Content" required name="Content" rows="6" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    {{$post->Content}}
                </textarea>
            </div>
